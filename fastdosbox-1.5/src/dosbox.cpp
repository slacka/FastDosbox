...
void DOSBOX_Init(void) {
	...
	Pstring = secprop->Add_string("machine",Property::Changeable::OnlyAtStart,"svga_et3000");
	...
	Pstring = secprop->Add_string("cputype",Property::Changeable::Always,"386");
	...
	secprop=control->AddSection_prop("gus",&GUS_Init,false); //done
...
//	secprop->AddInitFunction(&CREDITS_Init);
	...
	MSG_Add("CONFIGFILE_INTRO",
	        "# This is the configuration file for FastDOSBox %s\n"
